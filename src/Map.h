...
public:
    ...
    void LoadEntities(std::shared_ptr<Player>& player);//referencia del player
    //L15 TODO 4: Define a method to save entities to the map XML
    void SaveEntities(std::shared_ptr<Player>player);//aqui no se falta devueve referencia del player
public: 
